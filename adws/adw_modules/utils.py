...
def check_env_vars(logger: Optional[logging.Logger] = None) -> None:
    ...
    Note: ANTHROPIC_API_KEY is NOT required when using authenticated Claude Code (Max Plan).
    ...
    """
    required_vars = [
        # ANTHROPIC_API_KEY removed - not needed for authenticated Claude Code (Max Plan)
        "CLAUDE_CODE_PATH",
    ]
